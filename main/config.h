...
// LEDs, buttons, power
#define LED_EN_GPIO GPIO_NUM_18
#define BUILTIN_LED_GPIO GPIO_NUM_10
#define BOOT_BUTTON_GPIO GPIO_NUM_0
#define POWER_OFF_BUTTON_GPIO GPIO_NUM_8
#define SYS_POWER_ON GPIO_NUM_7

// Battery charge indication
#define CHARGE_ING_GPIO GPIO_NUM_45
#define CHARGE_FULL_GPIO GPIO_NUM_38

/* Optional display configuration (currently disabled)
